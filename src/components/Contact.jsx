...
export const Contact = () => {
  return (
    <div>
      ...
      <div className="justify-between mx-4 flex gap-4 ">
        <div className="h-96 relative">
          <img className="h-full" src={dp} alt="" />
          <div className="flex flex-col gap-1 absolute -bottom-1 right-2">
            <p className="text-[#00005b] bg-[#9a9aff] h-11 w-11 flex items-center justify-center rounded-full overflow-hidden">
              <div>
                <SiAdobepremierepro className="text-5xl" />
              </div>
            </p>
            <p className="text-[#00005b] bg-[#9999ff] h-11 w-11 flex items-center justify-center rounded-full overflow-hidden">
              <div>
                <SiAdobeaftereffects className="text-5xl" />
              </div>
            </p>
            <p className="text-[#001126] bg-[#229bff] h-11 w-11 flex items-center justify-center rounded-full overflow-hidden">
              <div>
        ...
        <div className="flex-1 flex flex-col gap-4">
          <div
            id="about"
            className="font-one flex flex-col gap-4 py-8 px-8 bg-[#cccccc] rounded-2xl flex-1"
          >
            <h3 className="text-lg">My Background</h3>
            <p>
          ...
          <div
            id="contact"
            className="font-one flex flex-col gap-4 py-8 px-8 bg-[#cccccc] rounded-2xl"
          >
